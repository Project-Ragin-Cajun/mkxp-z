...
class GodRayShader : public ShaderBase
{
public:
    GodRayShader();

    void setLightPosition(const Vec2& value) const;
    void setRayColor(const Vec4& value) const;
    void setIntensity(float value) const;
    void setDecay(float value) const;
    void setRayDensity(float value) const;
    void setRaySharpness(float value) const;
    void setPhase(float value) const;

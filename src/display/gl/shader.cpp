...
{
    INIT_SHADER(simple, godRay, GodRayShader);
    init();
...
void GodRayShader::setLightPosition(const Vec2& value) const
{
    setVec2Uniform(u_lightPosition, value);
}

void GodRayShader::setRayColor(const Vec4& value) const
{
    setVec4Uniform(u_rayColor, value);
}

void GodRayShader::setIntensity(const float value) const
{
    gl.Uniform1f(u_intensity, value);
}

void GodRayShader::setDecay(const float value) const
{
    gl.Uniform1f(u_decay, value);
}

void GodRayShader::setRayDensity(const float value) const
{
    gl.Uniform1f(u_rayDensity, value);
}

void GodRayShader::setRaySharpness(const float value) const
{
    gl.Uniform1f(u_raySharpness, value);
}

void GodRayShader::setPhase(const float value) const
{
    gl.Uniform1f(u_phase, value);
}
